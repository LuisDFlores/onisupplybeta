        ...
        return (
            <div className="text-white">
                <div className="max-w-[800px] mt[96px] w-full h-screen mx-auto text-center flex flex-col justify-center">
                    <p className=" text-[#00df9a] font-bold p-2">To go beyond your Potential</p>
                    ...
                    <button className="bg-[#00dfa9] w-[200px] rounded-md font-medium my-6 mx-auto py-3 text-black">Shop Now</button>
                    </div>
            </div>
        )
    }
